...
export default function RegisterForm() {
    const {data:complexesList} = useFetch('https://admincomforthome.online/api/get/complexes');
    ...
    const handleSubmit = async (event) => {
        ...
        if(password === repeatPassword){
            ...
            try{
                const response = await Axios.post('https://admincomforthome.online/api/insert', admin, {
                    headers: {
