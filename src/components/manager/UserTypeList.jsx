...
export default function UserTypeList({ userTypeList, setUserTypesUrl }) {
    ...
    useEffect(() => {
        if (formSubmitted) {
            setUserTypesUrl('http://localhost:3001/api/adminapi/get/userTypes?timestamp=' + Date.now());
    ...
    const columns = [
        ...
        { field: 'Type_Name', headerName: 'ტიპი', flex: 1 },
        {
            field: 'actions',
            headerName: 'Actions',
            width: 200,
